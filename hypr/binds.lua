...
hl.bind(mod .. " + U", hl.dsp.exec_cmd("[float; move cursor 20 20] " .. term .. " -o close_on_child_death=y sh -c 'kitten unicode-input | wl-copy -n'"))
hl.bind(mod .. " + V", hl.dsp.exec_cmd("[float; move cursor 20 20] " .. term .. " -o confirm_os_window_close=0 -o close_on_child_exit=yes -o allow_remote_control=yes -e bash " .. path .. "/clipfzf.sh"))
